...
class TestWorkQueue:
    def test_task_queue_is_empty(self, test_queue) -> None:
        # Verify task queue is empty by default
        assert_that(test_queue.get_tasks_num()).is_equal_to(0)

    def test_add_task(self, test_queue) -> None:
        # Add a task to queue
    ...
    def test_get_task_for_enabled_sid(self, test_queue) -> None:
        # Add a task to queue
        test_queue.add_task('test_task')
    ...
    def test_get_task_for_not_enabled_sid(self, test_queue) -> None:
        # Add a task to queue
        test_queue.add_task('test_task')
    ...
    def test_default_next_sid(self, test_queue) -> None:
        # Verify next sid is None by default
        assert_that(test_queue.next_sid).is_equal_to(None)

    def test_set_next_worker(self, test_queue) -> None:
        # Set next worker
    ...
    def test_illegal_set_next_worker(self, test_queue) -> None:
        # Set next worker
        test_queue.set_next_worker(5)
    ...
    def test_get_tasks_num(self, test_queue, create_tasks) -> None:
        # Verify task count is correct
        assert_that(test_queue.get_tasks_num()).is_equal_to(9)

    def test_default_check_end(self, test_queue) -> None:
        # Verify un-stopped state
        assert_that(test_queue.check_end()).is_equal_to(False)

    def test_stop_threads_check_end(self, test_queue) -> None:
        # Stop execution
    ...
    def test_re_enable(self, test_queue) -> None:
        # Stop execution
        test_queue.stop_threads()
